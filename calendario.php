...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>Calendario | INJUVENTUD</title>
  ...
  <div class="row">
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="sidebarMenuLabel"><img src="img/logo_injuventud_0.png" class="" width="30" height="30" alt=""> INJUVENTUD</h5>
        ...
        ?>
          ...
          <ul class="nav flex-column mb-auto">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="#" data-bs-toggle="modal" data-bs-target="#agregarUser">
                <i class="bi bi-person-plus-fill"></i>
                Agregar usuario
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="#" onclick="queryUser()">
        ...
        ?>
          ...
          <ul class="nav flex-column mb-auto">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="#" data-bs-toggle="modal" data-bs-target="#agregarActividad">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row">
        ...
        <div class="col-6">
          <div class="input-group mb-3">
            ...
            <select class="form-select" aria-label="Default select example" id="mes" onchange="calendarioQuery()">
        ...
        <div class="col-6">
          <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1"><i class="bi bi-calendar-event-fill"></i></span>
            <select class="form-select" aria-label="Default select example" id="annio" onchange="calendarioQuery()">
      ...
      <div class="calendar">
        ...
        <div class="row" id="calendarioGrid">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel"><i class="bi bi-clipboard-plus-fill"></i> Agregar actividad (<span id="fechaId"></span>)</h1>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="guardarActividades()"><i class="bi bi-floppy2-fill"></i> Guardar actividad</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" placeholder="Agregar colaborador" aria-label="Agregar colaborador" aria-describedby="basic-addon1" id="nombre">
        </div>        
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-plus-fill"></i></span>
          <input type="text" class="form-control" placeholder="Agregar usuario" aria-label="Agregar usuario" aria-describedby="basic-addon1" id="alias">
        </div>        
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-passport"></i></span>
          <input type="password" class="form-control" placeholder="Agregar contraseña" aria-label="Agregar contraseña" aria-describedby="basic-addon1" id="pass">
        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-building-fill"></i></span>
          <select class="form-select" aria-label="Default select example" id="AreaAgregar" onchange="departamentosQueryAgregar(1,this.value)">
          </select>
        </div>
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-buildings"></i></span>
          <select class="form-select" aria-label="Default select example" id="DepartamentosAgregar">
          </select>
        </div>
                
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-palette-fill"></i></span>
          <input type="color" class="form-control" placeholder="Agregar color" aria-label="Agregar color" aria-describedby="basic-addon1" id="color">
        </div>        
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="agregarUsuarios()"><i class="bi bi-person-plus-fill"></i> Agregar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="editarUser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" id="idHidden" hidden>
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-plus-fill"></i></span>
          <input type="text" class="form-control" placeholder="Nombre completo" aria-label="Nombre completo" aria-describedby="basic-addon1" id="nombre1">
        </div>       
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-person-plus-fill"></i></span>
          <input type="text" class="form-control" placeholder="Nombre usuario" aria-label="Nombre usuario" aria-describedby="basic-addon1" id="user1">
        </div>        
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-passport"></i></span>
          <select class="form-select" aria-label="Default select example" placeholder="Perfil" id="perfilEditar">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-passport"></i></span>
          <select class="form-select" aria-label="Default select example" placeholder="Estatus" id="estatusUser">
            <option value="">Estatus ...</option>
        ...
        <div class="input-group mb-3">
          ...
          <select class="form-select" aria-label="Default select example" placeholder="Área" id="areaEditar" onchange="departamentosQueryAgregar(2,this.value)">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-palette"></i></span>
          <select class="form-select" aria-label="Default select example" placeholder="Departamento" id="departamentoEditar">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1"><i class="bi bi-palette"></i></span>
          <input type="color" class="form-control" placeholder="Color" aria-label="Color" aria-describedby="basic-addon1" id="colorEditar">
        </div>        
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#queryColaboradores">Cerrar</button>
        <button type="button" class="btn btn-primary" onclick="editarUsuarios()"><i class="bi bi-person-plus-fill"></i> Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="queryColaboradores" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Listado de colaboradores</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <span id="queryUser"></span>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
      </div>
    </div>
