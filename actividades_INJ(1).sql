...
--
-- Servidor: localhost
-- Tiempo de generación: 13-02-2024 a las 18:00:39
...
(23, 'Actividad extra', 4, 'Actividad extra', '2024-02-01', 4, 'Actividad extra', 10, 'Actividad extra', 'Actividad extra', 28, 30, 'Actividad extra', 2, '2024-02-07 17:26:40'),
...
CREATE TABLE `users` (
  ...
  `oic` int(11) NOT NULL,
  `rCuentas` int(11) NOT NULL,
  `rescateEsp` int(11) NOT NULL,
...
INSERT INTO `users` (`id`, `nombre`, `user`, `pwd`, `perfil`, `area`, `departamento`, `estatus`, `color`, `calendario`, `oic`, `rCuentas`, `rescateEsp`, `tickets`, `web`) VALUES
(1, 'Jesus Rodolfo Leaños', 'JEsusR', '123456789', 2, 1, 1, 1, '#e09d12', 1, 0, 0, 0, 0, 0),
(2, 'Rodolfo Leaños V', 'jesusrlv3', '25f9e794323b453885f5181f1b624d0b', 2, 5, 6, 1, '#c26ba4', 1, 0, 0, 0, 0, 0),
(3, 'Jesus Leaños', 'asss2', 'c2957c02247e150fa0fb0bd5d1249739', 2, 1, 1, 1, '#21a5c2', 1, 0, 0, 0, 0, 0),
(4, 'Jesus L Villegas', 'jesusrlv9', '25f9e794323b453885f5181f1b624d0b', 2, 3, 3, 1, '#0e1edb', 1, 0, 1, 0, 0, 0);
